...
var store = null
var reduxMeta = null
var reduxMetaContext = null

export const ReduxMeta = {
  initialize () {
    reduxMeta = new Meta()
    reduxMetaContext = createContext(reduxMeta)
  },

  getContext () {
    return reduxMetaContext
  }
}
...
export function ReDuxMetaProvider ({ children }) {
  return (
    <Provider store={store}>
      <reduxMetaContext.Provider value={reduxMeta}>
        { children }
      </reduxMetaContext.Provider>
    </Provider>
  )
}
